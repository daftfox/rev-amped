import { Device, FirmataBoard } from '../base';
...
/**
 * @classdesc
 * MajorTom is an extension of the default Device class, allowing for more specific control over its behaviour. Since we
 ...
 */
@injectable()
export class MajorTom extends Device {
    /**
    ...
    // platform = SUPPORTED_PLATFORMS.ESP_8266;
    ...
    constructor( id: string ) {
        ...
        Object.assign(this.platform.pinMap, {
            FAN: 16,
            POWER: 14,
        });
    ...
    //     this.firmataBoard.pinMode(this.platform.pinMap.FAN, FirmataBoard.PIN_MODE.OUTPUT);
    //     this.firmataBoard.pinMode(this.platform.pinMap.POWER, FirmataBoard.PIN_MODE.PWM);
    //
    //     const serialOptions = {
     ...
     *
     * @param {string} dtc A DTC status as per this site: https://www.obd-codes.com/trouble_codes/
    ...
    private setSupplyVoltage(voltage: number): void {
        ...
        this.firmataBoard.analogWrite(this.platform.pinMap.POWER, voltage);
    }
    ...
    //
    //     // dip it!
    //     this.firmataBoard.analogWrite(this.platform.pinMap.POWER, MajorTom.SUPPLY_VOLTAGE.LOW);
    //
    //     // ramp it!
